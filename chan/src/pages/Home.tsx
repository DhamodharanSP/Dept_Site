...
<section className="h-screen flex flex-col justify-center items-center px-4 relative overflow-hidden">
  ...
  {/* Multiple Floating Images - Each with unique positioning and animation */}
  {[
    { 
      src: "lovable-uploads/fornt4.jpg", 
    ...
    { 
      src: "lovable-uploads/fornt2.jpg", 
    ...
    { 
      src: "lovable-uploads/fornt5.jpg", 
    ...
    { 
      src: "lovable-uploads/front3.jpg", 
      size: "w-30 h-24 sm:w-32 sm:h-32",
    ...
    <motion.div
      key={index}
      className={`absolute ${img.size} ${img.position} rounded-lg overflow-hidden border-2 border-indigo-500/20 shadow-lg z-10`}
    ...
    >
      <img 
        src={img.src}
        alt={`CSE Department ${index + 1}`}
        className="w-full h-full object-cover object-center"
      />
      {/* Glow effect on hover */}
      <div className="absolute inset-0 bg-indigo-500/10 opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
    </motion.div>
  ))}
