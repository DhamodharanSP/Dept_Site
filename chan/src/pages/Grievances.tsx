        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <h4 className="text-lg font-semibold text-white mb-2">Mr. A. Mohamed Abu Bakkar Siddiq</h4>
              ...
              >
                <h4 className="text-lg font-semibold text-white mb-2">Ms. R. Abinaya</h4>
                <p className="text-slate-300 mb-4 flex items-center gap-2">
